...
const AvailableFoodsSkeleton = () => {
    return (
        <div>
            ...
            >
                <div className="w-full flex items-center justify-center h-60 mb-4 bg-gray-300 rounded dark:bg-gray-700">
                    <svg
                ...
                <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 mt-4 mb-2.5" />
                ...
                <div>
                    <button className="text-white w-20 py-2 px-6 text-sm font-medium h-4 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5" />
                </div>
            </div>
